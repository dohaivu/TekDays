	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
				...
				<li><g:link class="list" action="index" id="${tekMessageInstance?.event?.id}"><g:message code="default.list.label" args="[entityName]" /></g:link></li>
			</ul>
		</div>
		<div id="create-tekMessage" class="content scaffold-create" role="main">
			<h1>${tekMessageInstance?.event?.name} Forum - New Messages</h1>
